		...
		<div class="container app">
			<div class="row">
				<div class="col-sm-3 menu">
					<ul class="list-group">
						<li class="list-group-item"><a href="consultar_receitas.php">Receitas pendentes</a></li>
						<li class="list-group-item"><a href="nova_receita.php">Nova receita</a></li>
						<li class="list-group-item active"><a href="#">Todas receitas</a></li>
					</ul>
				</div>
